pipeline {
    ...
    stages {
        stage('SCM Checkout') { 
            steps {
               git branch: 'main', credentialsId: 'AKIA6ODU4YRF7UCSSK6K', url: 'https://github.com/hossain109/SchoolManagement.git'
            }
        }
        stage('Build and Push Docker Image') { 
            steps{
                script {
                    withCredentials([usernamePassword(credentialsId: 'AKIA6ODU4YRF7UCSSK6K', usernameVariable: 'AKIA6ODU4YRF7UCSSK6K ', 
